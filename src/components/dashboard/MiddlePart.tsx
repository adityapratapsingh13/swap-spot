            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden flex flex-col md:flex-row items-center">
                    <div className="w-full p-6 md:w-1/2">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">
                            Transform your unused items into cash by listing
                            them easily within your college community. Connect
                            with potential buyers right on campus.
                        </p>
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden flex flex-col md:flex-row items-center">
                    ...
                    <div className="w-full p-6 md:w-1/2 text-right">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">
                            Discover great deals from fellow students. Browse
                            unique items, chat directly, and make secure
                            transactions within your college network.
                        </p>
